...
type Device struct {
	...
	Dot1xPortControlEnabled    bool                      `json:"dot1x_portctrl_enabled,omitempty"`
	EthernetOverrides          []DeviceEthernetOverrides `json:"ethernet_overrides,omitempty"`
	FlowControlEnabled         bool                      `json:"flowctrl_enabled,omitempty"`
	...
	PowerSourceControl         string                    `json:"power_source_ctrl,omitempty"` // auto|8023af|8023at|8023bt-type3|8023bt-type4|pasv24|poe-injector|ac|adapter|dc|rps
	PowerSourceControlEnabled  bool                      `json:"power_source_ctrl_enabled,omitempty"`
...
type DevicePortOverrides struct {
	...
	Autonegotiation              bool     `json:"autoneg,omitempty"`
	...
	StormControlBroadcastEnabled bool     `json:"stormctrl_bcast_enabled,omitempty"`
	...
	StormControlMulticastEnabled bool     `json:"stormctrl_mcast_enabled,omitempty"`
	...
	StormControlUnicastEnabled   bool     `json:"stormctrl_ucast_enabled,omitempty"`
